import * as PIXI from 'https://unpkg.com/pixi.js@6.5.10/dist/esm/pixi.min.mjs';
...
export const createCanvasRenderer = (target: HTMLElement): Renderer => {
	...
	const setupCanvas = () => {
		...
		border.drawRect(BLOCK_W * (WORLD_W + 1), 0, BLOCK_W, BLOCK_W * (WORLD_H + 2));
		border.drawRect(0, BLOCK_W * (WORLD_H + 1), BLOCK_W * (WORLD_H + 2), BLOCK_W);
